                    ...
                    return (
                      <div key={section.category}>
                        <button
                          ...
                          className="qo-header w-full flex items-center justify-between px-4 py-3 text-sm font-semibold uppercase tracking-wide"
                        >
                          <span>
                              ...
                              >
                                ...
                                <div className={`px-4 ${rowPadClass}`}>
                                  <img
                                    src={p.image}
                                    alt={p.name}
                                    className="qo-image object-contain rounded-lg bg-white border border-slate-200"
                                  />
                                </div>
                                <div className={`px-4 ${rowPadClass}`}>
                ...
                {sections.map((section) => {
                  ...
                  return (
                    <div key={section.category}>
                      <button
                        onClick={() => toggleCategory(section.category)}
                        className="qo-header w-full flex items-center justify-between rounded-xl px-4 py-3 text-sm font-semibold uppercase tracking-wide shadow-sm"
                      >
